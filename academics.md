...
*(Project summary and details coming soon...)*
...
* **Retrospective / Lesson Learned:** *Direct survey estimates suffered from extreme variance due to small district sample sizes. There should've been some sort of diagnostic check for the model.*
...
* **Retrospective / Lesson Learned:** *Diagnostic check available in only 1 chapter. Trying to pull too many conclusions from a small piece of data.*
